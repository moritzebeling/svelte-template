    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 14, 8, 307);
    			attr_dev(div1, "class", "header");
    			add_location(div1, file$3, 13, 1, 278);
    			add_location(main, file$3, 22, 12, 445);
    			attr_dev(div2, "class", "wrapper");
    			add_location(div2, file$3, 20, 8, 410);
    			attr_dev(div3, "class", "page");
    			add_location(div3, file$3, 19, 4, 383);
    		},
    		m: function mount(target, anchor) {
